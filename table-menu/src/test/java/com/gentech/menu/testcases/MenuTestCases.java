...
//	}
	...
	public void shouldGetByName()
	{
		...
		List<Menu> ele = restTemplate.getForObject(URL+"getMenuByName?name="+returned.getName(),List.class);	
		assertNotNull(ele);
	...
	public void shouldGetByDescription()
	{
		...
		List<Menu> ele = restTemplate.getForObject(URL+"getMenuByDesc?name="+returned.getDescription(),List.class);	
		assertNotNull(ele);
	...
	@Test
	public void shouldGetByPrtailMatching()
	{
		Menu obj = new Menu();
		obj.setName("Black Coffe Cake");
		obj.setCategory("Drink");
		obj.setDescription("Mexican coffee with cream");
		obj.setPrice(Long.valueOf("899"));
		...
		List<Menu> ele = restTemplate.getForObject(URL+"getByPartial?val="+"Cake",List.class);	
		assertNotNull(ele);
